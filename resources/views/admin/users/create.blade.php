                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="password-confirm"
                                        class="required">{{ __('default.form.password-confirm') }}:</label>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data) {
                                $("#upozilla").empty();
                                $.each(data, function(key, value) {
                                    $("#upozilla").append('<option value="' + value +
                                        '">' + key + '</option>');
                                });
                                ...
                                if (data == "") {
                                    ...
                                    $("#upozilla").append(
                                        '<option value="0">City Corporation Don\'t have any Upozilla</option>'
                                        );
                                } else {
                                    $("#upozilla").removeAttr("disabled");
                                }
